...
std::string io_github_pumpkinxd_ZitNetworkAutoConnector::http_get(
    const std::string &hostname, const std::string content) {
...
[[nodiscard("Causing Memory Leak if you discard it's ret")]] static char * http_send_request(const char *hostname, const char *resource) {
